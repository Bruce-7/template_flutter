...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/gift_record.svg
  SvgGenImage get giftRecord => const SvgGenImage('assets/icons/gift_record.svg');

  /// File path: assets/icons/setting.svg
  SvgGenImage get setting => const SvgGenImage('assets/icons/setting.svg');

  /// List of all assets
  List<SvgGenImage> get values => [assets, giftRecord, setting];
}
